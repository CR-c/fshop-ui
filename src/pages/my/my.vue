...
const getUser = function(){
  console.log("my.vue-getUserFunction_begin")
  //从缓存中获取数据
...
onMounted( async ()=>{
  // if(stoken.userTokenStore().token==='' || stoken.userTokenStore().token===null){
...
<template>
  <scroll-view class="viewport" scroll-y enable-back-to-top>
    ...
    <view class="profile" :style="{ paddingTop: safeAreaInsets.top + 'px' }">
      <!-- 情况1：已登录 -->
      <view class="overview" v-if=" userInfo.loginStatus==='true' " >
